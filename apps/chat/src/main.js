...
export function configFromEnv(env = process.env) {
  ...
  return {
    ...
    harnessRunnerDownloadUrl: (env.MUNDUSX_HARNESS_RUNNER_DOWNLOAD_URL ?? "").trim()
      || "https://github.com/mundusx/releases/releases/download/cli-windows-v0.1.78/MundusX-Setup.exe",
    latestLocalAgentVersion: (env.MUNDUSX_LATEST_LOCAL_AGENT_VERSION ?? "").trim() || "0.1.78",
